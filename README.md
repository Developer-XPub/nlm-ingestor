...
BUILD (USE BUILD X IF ON M PLATFORM LOCALLY)
...
gcloud run services update nlm-ingestor \--image=us-central1-docker.pkg.dev/newspub-396117/cloud-run-source-deploy/nlm-ingestor:latest --region=us-central1
...
&& gcloud run services update nlm-ingestor \

--image=us-central1-docker.pkg.dev/newspub-396117/cloud-run-source-deploy/nlm-ingestor:latest \
